...
Generated: 2026-07-29T18:01:07Z
...
- PA: rows=52, avg before=8.122, avg after=10.325, avg delta=2.203, max abs delta=24.874
- PR: rows=52, avg before=9.327, avg after=11.982, avg delta=2.655, max abs delta=25.891
- PRA: rows=52, avg before=10.907, avg after=13.803, avg delta=2.895, max abs delta=29.161
