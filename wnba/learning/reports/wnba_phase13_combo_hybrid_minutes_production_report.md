...
Generated: 2026-07-16T11:31:59Z
...
- PA: rows=46, avg before=9.587, avg after=10.916, avg delta=1.329, max abs delta=11.577
- PR: rows=46, avg before=10.864, avg after=12.242, avg delta=1.378, max abs delta=11.468
- PRA: rows=46, avg before=12.735, avg after=14.498, avg delta=1.762, max abs delta=14.040
