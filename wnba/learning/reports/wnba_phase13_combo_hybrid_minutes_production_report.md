...
Generated: 2026-08-08T18:01:13Z
...
- PA: rows=74, avg before=10.051, avg after=10.284, avg delta=0.233, max abs delta=5.652
- PR: rows=74, avg before=11.295, avg after=11.074, avg delta=-0.221, max abs delta=9.077
- PRA: rows=74, avg before=13.246, avg after=13.399, avg delta=0.153, max abs delta=7.651
