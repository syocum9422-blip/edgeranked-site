...
Generated: 2026-08-07T22:31:08Z
...
- PA: rows=80, avg before=8.312, avg after=9.226, avg delta=0.914, max abs delta=10.212
- PR: rows=80, avg before=9.435, avg after=10.435, avg delta=1.000, max abs delta=12.962
- PRA: rows=80, avg before=11.091, avg after=12.274, avg delta=1.184, max abs delta=13.777
